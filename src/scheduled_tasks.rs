...
use windows::{
    ...
    Win32::System::{
        ...
        TaskScheduler::{
            ...
            TASK_LOGON_NONE, TASK_LOGON_TYPE, TASK_RUNLEVEL_HIGHEST, TASK_RUNLEVEL_LUA,
            TASK_RUNLEVEL_TYPE, TASK_RUN_IGNORE_CONSTRAINTS, TASK_TRIGGER_BOOT, TASK_TRIGGER_TYPE2,
        },
    },
};
